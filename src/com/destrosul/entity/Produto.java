...
public class Produto implements Serializable {
    ...
    public void setNrProduto(String nrProduto) {
        String oldNrProduto = this.nrProduto;
        this.nrProduto = nrProduto;
        changeSupport.firePropertyChange("nrProduto", oldNrProduto, nrProduto);
    }
    ...
    public String toString() {
        return "com.destrosul.model.Produto[ idProduto=" + idProduto + " ]";
    }
